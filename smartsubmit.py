...
def checkDisk(dir, machine):
	"""Attempts to read bytes from the beggining and end of every sample file on the disk. If no files are stores, it instead touches and reads a file on the drive. Returns False if there was an error."""
